 ...
 * @author Gupta
 */
public class CarOwnerDashboardTest {
    private CarOwnerDashboard mockCarOwnerDashboard;
    ...
    public void setUp() {
        ...
        // Create CarOwnerDashboard instance with the mocked connection
        mockCarOwnerDashboard = new CarOwnerDashboard(mockConnection);
